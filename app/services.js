app.factory('fireParse', function ($rootScope, $timeout, $routeParams, $http) {
	...
	*/
	...
	var config = {
		fireRoot: 'https://capitaltech.firebaseio.com',
		parseAppId: '6xudIQWWoXjyb2gHnQvWDa9ocIwjNxuU1bjM8rTE',
		parseJsKey: 'JEYJSCCbWFTZ1500U8ekWECzCR1PjIZ5hR8Gux7G',
		parseRestApiKey: 'UdIgGpzbyofM3OKeEqVbRKRQ6bCVEeFg3eLSMPR2'
	};
