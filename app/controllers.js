var MainCtrl = app.controller('MainCtrl', function($rootScope, $scope, $routeParams, $timeout, fireParse, angularFire){
	// window.addEventListener("online", function(e) {alert("online");})
	if(navigator.onLine){
		var userList = new Firebase("https://capitaltech.firebaseio.com/presence");
	...
	$scope.$on('authComplete', function(event, message) {
		if(navigator.onLine){
			...
			delete me.updatedAt
			var myRef = new Firebase('https://capitaltech.firebaseio.com/presence/'+me.objectId);
...
var GameCtrl = app.controller('GameCtrl', function($rootScope, $scope, $routeParams, $timeout, $http, gameTools){
	// window.addEventListener("online", function(e) {alert("online");})
	...
	*/
	...
	function setup(gameId){
		...
		var corpRef = new Firebase("https://capitaltech.firebaseio.com/corps");
		var gameRef = new Firebase("https://capitaltech.firebaseio.com/game/"+$routeParams.gameId);
		var boardRef = new Firebase("https://capitaltech.firebaseio.com/game/"+$routeParams.gameId+'/board');
		var pendingRef = new Firebase("https://capitaltech.firebaseio.com/game/"+$routeParams.gameId+'/pending');
		var userGameRef = new Firebase('https://capitaltech.firebaseio.com/presence/'+$rootScope.user.objectId+'/game');
...
var CorpCtrl = app.controller('CorpCtrl', function($rootScope, $scope, $routeParams, angularFire){
	var url = new Firebase("https://capitaltech.firebaseio.com/corps");
